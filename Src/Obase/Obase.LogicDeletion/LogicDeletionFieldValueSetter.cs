...
namespace Obase.LogicDeletion
{
    ...
    ///     逻辑删除的字段设值器
    /// </summary>
    public class LogicDeletionFieldValueSetter : IValueSetter
    {
        /// <summary>
        ///     表示要设值的字段。
        /// </summary>
        ...
        public LogicDeletionFieldValueSetter(FieldInfo fieldInfo, StructuralType structuralType)
        {
        ...
        /// </summary>
        /// <param name="structuralType">结构化类型</param>
        /// <param name="currentType">当前的运行时类型</param>
