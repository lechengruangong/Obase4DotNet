...
namespace Obase.Core.Query.Oop
{
    ...
    /// </summary>
    public class SkipExecutor<TSource> : OopExecutor
    {
        /// <summary>
        ///     要执行的查询运算
        /// </summary>
        private readonly SkipOp _op;
        ...
        {
            //略过
            context.Result = ((IEnumerable<TSource>)context.Result).Skip(_op.Count);
            //调用管道下一节处理
