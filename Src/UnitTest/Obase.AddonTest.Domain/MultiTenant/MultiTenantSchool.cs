...
///     定义了多租户字段的学校
/// </summary>
public class MultiTenantSchool
{
    /// <summary>
    ///     录入时间
    /// </summary>
    ...
    {
        return
            $"MultiTenantSchool:{{SchoolId-{_schoolId},Name-\"{_name}\",IsPrime-\"{_isPrime}\",EstablishmentTime-\"{_establishmentTime:yyyy-MM-dd}\",Createtime-\"{_createTime:yyyy-MM-dd}\",SchoolType-\"{_schoolType}\"}}";
    }
}