...
public class MultiTenantSchoolNoDef
{
    ...
    {
        return
            $"MultiTenantSchoolNoDef:{{SchoolId-{_schoolId},Name-\"{_name}\",IsPrime-\"{_isPrime}\",EstablishmentTime-\"{_establishmentTime:yyyy-MM-dd}\",Createtime-\"{_createTime:yyyy-MM-dd}\",SchoolType-\"{_schoolType}\"}}";
    }
}