...
///     未定义多租户字段的学校 标注配置
/// </summary>
[Entity("School", keyAttributes: "SchoolId")]
[MultiTenant("MultiTenantId", typeof(Guid))]
public class MultiTenantSchoolNoDefAnnotation
{
    /// <summary>
    ///     录入时间
    /// </summary>
    ...
    {
        return
            $"MultiTenantSchoolNoDefAnnotation:{{SchoolId-{_schoolId},Name-\"{_name}\",IsPrime-\"{_isPrime}\",EstablishmentTime-\"{_establishmentTime:yyyy-MM-dd}\",Createtime-\"{_createTime:yyyy-MM-dd}\",SchoolType-\"{_schoolType}\"}}";
    }
}