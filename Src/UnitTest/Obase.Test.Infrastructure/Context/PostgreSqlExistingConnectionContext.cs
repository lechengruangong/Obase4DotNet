...
/// </summary>
public class PostgreSqlExistingConnectionContext : ObjectContext
{
    /// <summary>
    ///     构造ObjectContext对象
    /// </summary>
    ...
    public PostgreSqlExistingConnectionContext(DbProviderFactory providerFactory, DbConnection connection,
        ...
        new PostgreSqlExistingConnectionContextConfiger(
            new ExistingConnectionSqlExecutor(providerFactory, connection, EDataSource.PostgreSql, transaction)))
    {
    }
}

/// <summary>
///     使用已存在的PostgreSql连接上下文配置
/// </summary>
public class PostgreSqlExistingConnectionContextConfiger : SqlContextConfigurator
{
    /// <summary>
    ///     使用已存在的PostgreSql连接上下文配置。
    /// </summary>
    ...
    public PostgreSqlExistingConnectionContextConfiger(ISqlExecutor sqlExecutor, bool enableStructMapping = false) :
